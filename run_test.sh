...
DATASETS=("AffectNet" "FairFace" "UTKFace" "RAF-DB" "LFW" "CelebA_HQ")  # List of datasets
BATCH_SIZE=16
BASE_DATASET_PATH="../processed_datasets/datasets_with_standard_labels"
BASE_OUTPUT_PATH="../TEST/PECore/SoftCPT/0010"
NUM_PROMPT=0
CKPT_DIR="../TRAIN/PECore/SoftCPT/0010/ckpt"
